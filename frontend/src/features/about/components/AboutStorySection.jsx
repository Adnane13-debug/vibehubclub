      ...
      <div className="grid items-center gap-16 lg:grid-cols-2">
        <div>
          ...
          <p className="mb-6 leading-relaxed text-slate-600 dark:text-slate-400">
            Founded by a group of visionary students who saw the need for a more
            integrated campus life, VibeHub Club bridges the gap between
            academic theory and real-world passion. We believe that true
          ...
          <p className="mb-8 leading-relaxed text-slate-600 dark:text-slate-400">
            ...
            pitching sessions, we provide the platform, the resources, and the
            community to make big ideas happen.
          </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-4 pt-12">
            ...
            <div className="aspect-[3/4] overflow-hidden rounded-2xl bg-primary/5">
              <img
          ...
          <div className="space-y-4">
            ...
            <div className="aspect-square overflow-hidden rounded-2xl bg-primary/5">
              <img
                ...
                className="h-full w-full object-cover"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCa4FPPSHHiWAVdjIppiX_UFxvooA8-l_aZWy_L4bRegPrDygQNOtAkoSw5lWaIK2PPIYypz_aEutDJBAUi8c9ZRro1zFGEiDQd6PCeeILKnzhlTXO7N8H8uc2efJx4BbuRmTCBCCVN7MSQumFMlOypDEo9Pyj8EcGafu83P0qdnEL57f2DS8oq8lvX2j76zTJtMvdDVH-VLc7TgvivEt7C2qNeqDWRoaGDCW8musN3guoWgmExJ6BZPhUekNSprgNsUQovUc97UcMI"
              />
            </div>
          </div>
        </div>
