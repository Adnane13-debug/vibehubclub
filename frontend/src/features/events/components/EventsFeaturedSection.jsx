    ...
    <div className="mt-20 rounded-2xl border border-primary/20 bg-primary/10 p-8 @container">
      <div className="flex flex-col items-center gap-8 md:flex-row">
        ...
        <div className="flex w-full flex-col gap-4 md:w-1/2">
          <div className="flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-primary-dark">
          ...
          <div className="mt-2 flex gap-4">
            ...
            <Link
              to="/events/featured-championship"
              className="flex h-12 min-w-[140px] items-center justify-center rounded-lg border border-slate-200 bg-white px-6 text-sm font-bold text-slate-900 transition-colors hover:bg-slate-50"
            >
              Learn More
            </Link>
          </div>
